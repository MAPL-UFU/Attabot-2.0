...
String generateMessage(){
  // Function to update data and generate a formatted message
    ...
    data += ", Light Sensor: true";
    data += ", " + generateDistanceReadingsMessage();
    data += ", " + generateAccelerometerMessage();
    data += ">";
...
{
  return collisionModule.getMessage();
}
...
String generateMotorValuesMessage()
{
  ...
  String rightMotorStr= handleMotorValues(rightMotorDirection);

  String message = "Motor Values: " + leftMotorStr + ", " + rightMotorStr;
  return message;
}
...
String generateAccelerometerMessage(){
  String message = "Accelerometer: { Euler: { X: " + String(mpuSensorData.eulerX);
  message += ", Y: " + String(mpuSensorData.eulerY);
  message += ", Z: " + String(mpuSensorData.eulerZ);
  message += " }, LinearAcc: { X: " + String(mpuSensorData.linearAccX);
  message += ", Y: " + String(mpuSensorData.linearAccY);
  message += ", Z: " + String(mpuSensorData.linearAccZ);
  message += " }, Gyro: { X: " + String(mpuSensorData.gyroX);
  message += ", Y: " + String(mpuSensorData.gyroY);
  message += ", Z: " + String(mpuSensorData.gyroZ);
  message += " } }";
